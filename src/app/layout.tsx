    ...
    <html lang="en">
      <head>
        {/*
          ...
          Poppins is added ONLY for the "Up" + "Digitly" logo mark (nav/footer) —
          matches the approved logo lockup; not used anywhere else in the type system.
        */}
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous" />
        <link
          href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;400;500;600;700&family=Inter:wght@300;400;500;600&family=JetBrains+Mono:wght@200;300;400;500&family=Poppins:wght@700;800&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
